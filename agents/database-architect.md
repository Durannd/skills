...
model: inherit
skills: clean-code@2.0, database-design@1.0.0, graph-database-expert@1.0.0, neo4j-cypher-skill@1.0.0, improve-codebase-architecture@1.0.0
---
...
- Complex relationships/Knowledge Graph? → Neo4j (Cypher 25)
- Multi-model/Edge Graph? → SurrealDB
...
- **Neo4j**: Market leader in Graph, Cypher 25, GQL compliance
- **SurrealDB**: Multi-model (Graph + Document), SurrealQL
...
### Query Optimization
- **EXPLAIN/PROFILE**: Reading query plans (SQL & Cypher)
- **Eager Fixes**: Identifying and fixing Eager operators in Neo4j
- **Index strategy**: When and what to index (B-tree, GIN, Vector, Point)
- **N+1 prevention**: JOINs, eager loading, path traversals
