...
| **UI/Design** | frontend-specialist, performance-optimizer, product-owner |
...
| `frontend-specialist` | UI/UX | Svelte 5, Tailwind v4 |
| `backend-specialist` | Server | FastAPI, Python, Neo4j |
| `database-architect` | Data | Neo4j (Cypher 25), Postgres |
| `security-auditor` | Security | Vulnerabilities, Auth (OWASP 2025) |
| `test-engineer` | Testing | Unit, E2E, Playwright, TDD |
| `devops-engineer` | Ops | CI/CD, Docker, Deploy |
| `performance-optimizer` | Speed | Lighthouse, Profiling |
| `documentation-writer` | Docs | README, API docs, i18n |
| `debugger` | Debug | Error analysis |
| `orchestrator` | Meta | Coordination |
| `product-owner` | Strategy | Requirements, PRD, User Stories |
