...
tags: [nextjs, react, performance, bundle, waterfall, server components, client components]
triggers:
  - "Next.js"
  - "React component"
  - "reduce bundle size"
...
related-skills: [tailwind-patterns, frontend-design, performance-profiling]
version: 1.0.0
---
