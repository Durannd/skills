...
| `svelte` | Runes ($state, $derived), snippets, SvelteKit structure |
| `html-tailwind` | Tailwind v4, CSS-first config, responsive, a11y |
...
| `shadcn` | shadcn/ui components (Svelte versions), theming |
...
| Rule | Do | Don't |
|------|----|----- |
| **No purple/violet** | Use Acid Green, Signal Orange, Deep Red | Use purple, violet, indigo, magenta |
| **Originality** | Break safe harbor clichés | Use "AI-style" neon glows |
