...
## 11. Design Audit & Guidelines

After coding, perform a systematic audit using these guidelines.

### Audit Checklist

| Area | Check |
|------|-------|
| **Accessibility** | All interactive elements have focus states, adequate contrast, and ARIA labels. |
| **Performance** | Images are lazy-loaded, fonts are optimized, and no render-blocking waterfalls. |
| **UX Consistency** | Spacing follows the 8pt grid, typography scale is consistent. |
| **Animations** | Use `prefers-reduced-motion`, animations are subtle and performant (transform/opacity). |
| **Focus States** | `focus-visible` is styled for all interactive elements. |

### Guidelines Source

For the most up-to-date accessibility and UX rules, refer to:
...
3. AUDIT    → Perform audit using Section 11 ← YOU ARE HERE
