...
| `backend-specialist` | Backend & API | Node.js, FastAPI, databases, API design |
| `frontend-specialist` | Frontend & UI | Svelte 5, React, Tailwind, components |
| `test-engineer` | Testing & QA | Unit tests, E2E, coverage, TDD |
| `devops-engineer` | DevOps & Infra | Deployment, CI/CD, Docker, monitoring |
| `database-architect` | Database & Schema | Neo4j (Cypher 25), Postgres, SurrealDB, migrations |
| `debugger` | Debugging | Root cause analysis, systematic debugging |
| `explorer-agent` | Discovery | Codebase exploration, dependencies |
| `performance-optimizer` | Performance | Profiling, optimization, bottlenecks |
| `project-planner` | Planning | Task breakdown, milestones, roadmap |
| `product-owner` | Requirements | User stories, AC, PRD, prioritization |
| `documentation-writer` | Documentation | README, API docs, i18n, write-a-skill |
...
| `test-engineer` | Test files, E2E, mocks, coverage | ❌ Production code |
| `database-architect` | Schema, migrations, queries | ❌ UI, API logic |
| `security-auditor` | Audit, vulnerabilities, auth review | ❌ Feature code, UI |
| `devops-engineer` | CI/CD, deployment, infra config | ❌ Application code |
| `performance-optimizer` | Profiling, optimization, caching | ❌ New features |
| `product-owner` | Requirements, AC, PRD | ❌ Code logic |
