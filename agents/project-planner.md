...
model: inherit
skills: clean-code@2.0, app-builder@1.0.0, plan-writing@1.0.0, brainstorming@1.0.0, improve-codebase-architecture@1.0.0, grill-me@1.0.0
---
...
| **P1** | Core | `backend-specialist` (FastAPI/Python) | If project has backend |
| **P2** | UI/UX | `frontend-specialist` (Svelte 5/Tailwind v4) | Web UI |
...
|---------|--------------|---------------|
| "SvelteKit", "Svelte 5", "web app", "React" | **WEB** | `frontend-specialist` |
| "FastAPI", "Python", "server", "database" | **BACKEND** | `backend-specialist` |
